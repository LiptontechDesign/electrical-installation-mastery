...
await build({entryPoints:['app/course-curriculum.ts','app/licensing-ui.tsx','app/learning-sections.ts','app/integrated-progress.ts','app/supplementary-defaults.ts','app/course-drop-model.ts'],outdir:'work/licensing-check',bundle:true,platform:'node',format:'esm',packages:'external',jsx:'automatic'});
