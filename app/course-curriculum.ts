...
const moduleCopy: Record<string, { title?: string; description: string; learningOutcome: string; entry: string }> = {
  'module-01': { description: 'Build from charge and circuits through resistance, AC power, transformers and measurement principles in short study sections.', learningOutcome: 'Explain a circuit, calculate AC power and distinguish what electrical instruments measure.', entry: 'Start here. No retained electrical knowledge is assumed. Study measurement demonstrations as theory; complete safe-isolation training in Module 3 before practical installation work.' },
  'module-02': { description: 'Recognise installation components and read the drawings that connect them.', learningOutcome: 'Trace a circuit from its single-line diagram to its protective device and load.', entry: 'Use the circuit and safety foundations from Module 1 to identify real equipment and its drawings.' },
  'module-03': { description: 'Choose tools, prepare conductors and follow diagrams through to sound terminations.', learningOutcome: 'Explain each connection and the inspection needed before energising it.', entry: 'Use the components and drawings from Module 2. Complete the safe-isolation lesson before practical work.' },
  'module-04': { title: 'Containment and Cable Systems', description: 'Progress from conduit and capacity to cable construction, glanding and installation methods.', learningOutcome: 'Justify a wiring route, containment system and termination method for its environment.', entry: 'Build on conductor preparation and termination in Module 3.' },
  'module-05': { description: 'Connect fault types, earthing, disconnection, device selection and surge protection.', learningOutcome: 'Explain which protective function responds to each fault and what evidence confirms suitability.', entry: 'Use the conductor and wiring-system knowledge from Modules 3–4 to follow complete fault paths.' },
  'module-06': { title: 'Three-Phase Theory, Design and Calculations', description: 'Learn phase relationships before calculating demand, cable capacity, voltage drop and fault ratings.', learningOutcome: 'Produce a justified load calculation and explain every cable and protection check.', entry: 'Recall AC power from Module 1 and protective measures from Module 5; three-phase foundations come first here.' },
  'module-07': { title: 'Motors and Building Distribution', description: 'Connect motor behaviour to starters and drives, then scale the design to building distribution.', learningOutcome: 'Read a motor nameplate, distinguish starting methods and justify a distribution arrangement.', entry: 'Use Module 6’s star/delta relationships and design calculations before studying motors and distribution.' },
  'module-08': { description: 'Begin with three-phase safe isolation, then connect dead tests, live verification, installation certification and periodic inspection.', learningOutcome: 'Explain the purpose, limitations and record of each test before interpreting an installation report.', entry: 'Use the protection, design and distribution knowledge from Modules 5–7. Begin with safe isolation before dead tests; live testing requires competence and suitable controls.' },
  'module-09': { description: 'Use inspection and test evidence to narrow faults and verify repairs.', learningOutcome: 'Build a fault hypothesis from evidence, investigate it and specify the necessary retests.', entry: 'Use Module 8’s inspection and test methods to distinguish a real fault from a misleading reading.' },
  'module-10': { title: 'Integrated Installation Projects', description: 'Follow a project from load estimation and service detection through first fix, second fix and final verification.', learningOutcome: 'Explain the complete job sequence and the decisions that need checking on site.', entry: 'Apply Modules 1–9 as a connected design, installation and verification workflow.' },
  'module-11': { description: 'Survey hidden services before coordinating routes, finishes and residential first-fix decisions.', learningOutcome: 'Produce a coordinated first-fix brief with access, services and client decisions resolved.', entry: 'Build on the complete projects in Module 10; survey hidden services before drilling or chasing.' },
  'module-12': { description: 'Start with the visual task, calculate light levels, then specify fittings, controls and maintainable details.', learningOutcome: 'Explain a lighting scheme using both calculations and the way people use the space.', entry: 'Use the room brief and coordinated service routes from Module 11.' },
  'module-13': { description: 'Connect controls, data networks, security and life-safety interfaces to a documented commissioning plan.', learningOutcome: 'Describe the power, communication and safety boundaries of a connected building system.', entry: 'Build on the control groups and client requirements developed in Module 12.' },
  'module-14': { description: 'Survey the supply and identify every energy source before PV, storage, backup and EV installation cases.', learningOutcome: 'Map every source, isolation point and protection boundary in a proposed energy system.', entry: 'Apply the protection, distribution and commissioning principles from Modules 5–8 to multiple-source installations.' },
  'module-15': { title: 'Applied Building Services', description: 'Apply motor controls and protection to pumps, ventilation and sensitive lighting systems.', learningOutcome: 'Explain operating modes, failure responses and maintenance access for a building service.', entry: 'Apply Module 7’s motor principles and Module 12’s lighting design to complete building services.' },
...
export const legacyModules = originalModules.map(module => {
  ...
  return { ...module, title: copy.title ?? module.title, description: copy.description, learningOutcome: copy.learningOutcome, lessons, durationSeconds, duration: formatStudyDuration(durationSeconds) };
});
