...
export default function BookReader({ initialReading, onClose }: { initialReading?: Reading; onClose: () => void }) {
  ...
  return <dialog ref={dialog} className="book-reader-dialog" aria-labelledby="book-reader-title" onCancel={onClose}><header className="book-reader-header"><div><BookOpen size={22} /><h2 id="book-reader-title">My books</h2></div><button type="button" aria-label="Close book reader" onClick={onClose}><X size={23} /></button></header><ReaderSession initialReading={initialReading}/></dialog>;
}
