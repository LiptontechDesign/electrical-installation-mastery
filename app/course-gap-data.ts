...
const equipment = { regulationSensitive: true, regulationStatus: 'Use the actual equipment instructions and applicable current installation requirements. This video explains a principle or a particular product; it does not specify a installation.' };

// Only additions accepted by the September 2026 whole-course review.
export const gapLessons: LessonSeed[] = [
  L('p01-transformers', 'Transformers: Changing Flux, Turns and Voltage', 'UchitHGF4n8', 'The Engineering Mindset', 390, 'Transformers', 'WHY', 'Educator', G(
  ...
  L('p01-pf-visual', 'Power Factor: See Real, Reactive and Apparent Power', 'Tv_7XWf96gg', 'The Engineering Mindset', 669, 'Power factor', 'WHY', 'Educator', G(
  ...
  L('p07-induction', 'Induction Motors: Rotating Field, Rotor and Slip', '59HBoIXzX_c', 'The Engineering Mindset', 933, 'Induction motors', 'WHY', 'Educator', G(
  ...
  L('p07-star-delta', 'Star–Delta Starting: Sequence and Interlocks', 'h89TTwlNnpY', 'The Engineering Mindset', 668, 'Motor starting', 'HOW', 'Educator', G(
  ...
  L('p07-vfd', 'Variable-Frequency Drives: From Rectifier to Motor Speed', 'yEPe7RDtkgo', 'The Engineering Mindset', 917, 'Variable-frequency drives', 'WHY', 'Educator', G(
  ...
  L('p05-spd', 'Surge Protection: What an SPD Test Can Tell You', 'N-ocwOCoPfE', 'eFIXX', 421, 'Surge protection', 'HOW', 'Manufacturer or trade specialist', G(
  ...
  L('p08-periodic', 'Periodic Inspection: Follow the Evidence Through an EICR', '1tBICSsjVWo', 'Artisan Electrics', 3584, 'Periodic inspection', 'APPLY', 'Educator', G(
    'Follow this 2018 home inspection from visual checks to recorded observations. After learning the individual tests, separate observation from inference and check historical defect codes against current guidance.',
  ...
  ), { ...equipment, regulationStatus: 'Historical EICR case study (2018). Use current IET guidance to interpret the observations and applicable requirements for local reporting. Do not copy the video’s defect codes or edition-specific test limits.' }),
];
