          ...
          {view === 'practice' && (
            <div className="page practice-page">
              ...
              <section className="mastery-centre">
                <div className="section-heading"><div><span className="eyebrow neutral"><Award size={16} /> Module mastery centre</span><h2>Deep review for every module</h2></div><p>Choose a module, retrieve 30 ideas and complete a 30-question assessment. Wrong answers return to spaced review.</p></div>
