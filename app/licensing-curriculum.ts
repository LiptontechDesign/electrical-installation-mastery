...
export function buildLicensingModules<T extends ExistingModule>(legacy:T[]) {
  ...
  const stages:Stage[] = [
    ...
    {id:'module-05',path:'C2',title:'Faults, Protective Devices, Earthing and ADS',ids:['p05-l01','p02-l06','p05-l02','p05-l03','p05-l05','p02-l04','p02-l05','p05-l08','p05-l07','p05-l06','p05-l10','p05-l11','p02-l07','p05-l04','p02-l08','p05-l15','p05-spd','p05-l14'],purpose:'Fault → overcurrent protection → earth fault, earthing and ADS → residual-current protection → surge, arc and special protection → device selection and coordination. Different instructors reinforce the protective functions; formal testing follows in C2-08.'},
    ...
    {id:'c2-boards',path:'C2',title:'Consumer Units and Complete Single-Phase Installation',ids:['p03-l13','p03-l12','p02-l10','p10-l01','p10-l02','p10-l05'],purpose:'Begin with correct torque and consumer-unit assembly, then study the longer-tail/switch-fuse special case and complete single-phase installation examples. Preview verification; formal testing follows next.'},
    ...
    {id:'module-09',path:'C2',title:'C2 Fault Finding',ids:['p09-l01','p09-l02','p09-l04','p09-l05','p09-l08','p09-l03','p09-l06','p09-l07','p09-l09','p09-l10','p09-l11'],purpose:'Identify the symptom → establish a safe state → classify the fault family → choose a test that separates possible causes → localize → repair → retest. Progress from continuity paths to insulation/leakage and then load-current diagnosis.'},
    ...
    {id:'c1-power',path:'C1',title:'Three-Phase Power Calculations',ids:['p06-l13'],purpose:'Extend the AC power model to line/phase values, star/delta relationships and three-phase calculations.'},
    {id:'c1-distribution',path:'C1',title:'Three-Phase Distribution and Installation',ids:['p08-l01','p02-l11','p11-v2-l11','p07-l06','p07-l07','p07-l08','p07-l09','p10-l06','p10-l07'],purpose:'Start with three-phase safe isolation, then trace boards, feeders, outlets, phase allocation and practical building-distribution installations. Load estimation and sizing follow in the design stage.'},
    {id:'c1-design',path:'C1',title:'Three-Phase Design and Protective-Device Selection',ids:['p10-l10','p07-l16','p06-l05'],purpose:'Move from load estimation and building demand through distribution sizing to a complete three-phase cable and protective-device design. UK tables remain source examples, not Kenyan regulatory approval.'},
    {id:'c1-earthing',path:'C1',title:'Small-Commercial Earthing and Protection Application',ids:['p05-l12','p05-l13'],purpose:'Apply the C2 fault-path model immediately after three-phase design, using detailed impedance calculations and design evidence to connect earthing with protective-device operation.'},
    ...
    {id:'c1-faults',path:'C1',title:'Three-Phase Distribution Fault Diagnosis',ids:['p10-l08','p16-l06'],purpose:'Use distribution-board and thermal evidence critically. Motor phase-loss and imbalance diagnosis need additional supervised practice, not inference from these videos alone.'},
