...
export default function StudyCentre() {
  ...
  return <div className="epra-centre">
    ...
    <footer className="epra-centre-footer"><GraduationCap size={20}/><p><strong>Understanding comes before speed.</strong> Full questions. Complete answers. Space to work at your own pace.</p><span>Session-only practice<br/>No sign-in required</span></footer>
  </div>;
}
