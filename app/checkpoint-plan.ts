...
const stageGroups:Record<string,readonly (readonly [string,string])[]>={
  ...
  'c2-boards':[['p03-l12','Consumer-unit assembly and connections'],['p02-l10','Meter tails and switch-fuse arrangements'],['p10-l05','Complete single-phase installation cases']],
  'module-08':[['p08-l06','Inspection, continuity, insulation and polarity'],['p08-l10','Earthing verification and controlled live tests'],['p16-l09','RCD, functional checks and documentation']],
  'c1-distribution':[['p11-v2-l11','Safe isolation and industrial accessories'],['p07-l09','Boards, feeders and phase allocation'],['p10-l07','Three-phase installation projects']],
  'c1-design':[['p07-l16','Load estimation and building demand'],['p06-l05','Cable and protective-device design']],
  'c1-earthing':[['p05-l13','Earthing, fault paths and protection calculations']],
